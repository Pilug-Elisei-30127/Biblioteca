...
namespace Biblioteca.Controllers
{
    public class UsersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,FullName,Username,Email,Password,Role")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,FullName,Username,Email,Password,Role")] User user)
        {
            if (ModelState.IsValid)
            {
