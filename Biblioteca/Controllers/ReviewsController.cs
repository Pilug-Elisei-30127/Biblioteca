...
namespace Biblioteca.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        {
            var reviews = db.Reviews.Include(r => r.Books).Include(r => r.Users);
        ...
        public ActionResult Create([Bind(Include = "Id,BookId,UserId,Text,Rating")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,BookId,UserId,Text,Rating")] Review review)
        {
            if (ModelState.IsValid)
            {
